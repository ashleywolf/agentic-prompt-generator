...
### Production Example
- copilot-sre — Azure SLO monitoring with weekly reports
...
> Timeouts in ospo-aw range from 5 to 120 minutes with no clear correlation to complexity. Use these recommendations by archetype:
...
These six sub-archetypes emerged from the ospo-aw analysis. Each is a variant of the core eight, specialized for a common real-world pattern.
